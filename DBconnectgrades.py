...
dbconn = my.connect (host='127.0.0.1',port=3306,user='root', password='',  db='databaseclass2021')
 
#print(dbconn) #This is a testing stub to make sure the connection worked. Uncomment it to use it.
cursor = dbconn.cursor()
query = "SELECT FirstName, LastName, DOB, Vac_status from covid_info join patient_demo on patient_demo.MRN = covid_info.MRN"
